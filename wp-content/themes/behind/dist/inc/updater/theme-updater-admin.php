...
class Themedd_Updater_Admin {
	...
	function license_page() {
		...
		<div class="wrap license-wrap">
			<h2 class="headline">第四维网络主题激活</h2>
			<div class="themedd-license-management-wrap">
				<p>
                    输入您在<a href="https://4wl.cn/">第四维网络</a>免费申请的授权密钥
                <ol>
                    <li>十分感谢您使用第四维网络制作的免费WordPress主题 </li>
                    <li>为了更好的完善这个WordPress主题，我们诚挚的邀请您到<a href="https://4wl.cn/theme/chop">第四维网络</a>申请一个授权码，激活主题</li>
                    <li>激活主题以后，您可以享受到更加便捷的WordPress后台一键升级服务 </li>
                </ol>
                </p>
				...
				<form method="post" action="options.php">
					...
					<?php
						...
						submit_button( __( '更新授权码', 'themedd' ) );
					?>
				</form>
			</div>
		</div>
