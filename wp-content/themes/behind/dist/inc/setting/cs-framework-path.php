 ...
 *
 */
if ( ! function_exists( 'the4' ) ) {
    function the4( $option_name = '', $default = '' ) {

        $options = apply_filters( 'the4', get_option( CS_OPTION ), $option_name, $default );
